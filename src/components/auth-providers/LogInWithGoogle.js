...
//helpers
import { saveClientUserToDB, checkIfEmailIsRegistered } from '@helpers/DbHelper'
        ...
        try{
            const unsubscribe = onAuthStateChanged(auth, (firebaseUser) => {
                ...
                if (!isUserEqual(googleUser, firebaseUser)) {
                    ...
                    .then(async () => {
                        const emailIsRegistered = await checkIfEmailIsRegistered(googleUser.user.email);
                        !emailIsRegistered && saveAccountToDB(googleUser);
                    }).catch((error) => {
                    // Handle Errors here.
