const FormErrorMessages = {
    ...
    ar: {
      ...
      birthday: 'الحقل "{0}" يجب أن يكون تاريخ صحيح ({1}).',
    ...
    fr: {
      ...
      birthday: 'Le champ "{0}" doit correspondre à une birthday valide ({1}).',
    ...
    fa: {
      ...
      birthday: 'فیلد "{0}" باید یک تاریخ ({1}) باشد.',
    ...
    id: {
      ...
      birthday: 'Format tanggal pada "{0}" harus ({1})',
    ...
    ptBR: {
      ...
      phoneNumber: 'Esse "{0}" não é válido.',
      cpf: 'Esse "{0}" não é válido.',
      email: 'O campo "{0}" precisa conter um email válido.',
      required: 'O campo "{0}" é obrigatório.',
      birthday: 'O campo "{0}" precisa conter uma data válida.',
    ...
    es: {
      ...
      birthday: 'El campo "{0}" debe contener una fecha válida ({1}).',
    ...
    tr: {
      ...
      birthday: '"{0}" alanı geçerli bir tarih olmalıdır. ({1}).',
    ...
    it: {
      ...
      birthday: 'Il campo "{0}" deve contenere una data valida ({1}).',
